...
DECODER_SOURCE_CHECKPOINT = "/workspace/le-wm/runs/20260328-132542-pusht/lewm_epoch_13_object.ckpt"
DECODER_SOURCE_MODEL_MODE = "eval"
DECODER_RESUME_CHECKPOINT = "/workspace/le-wm/runs/20260402-072332-decoder/lewm_decoder_epoch_1_object.ckpt"
...
DECODER_WRITE_EVERY_STEPS = 500
DECODER_PLOT_EVERY_STEPS = 500
DECODER_PLOT_EVERY_EPOCHS = 1
DECODER_SAVE_TSV = True

DECODER_NUM_VIS_SAMPLES = 4
DECODER_TOPK_FRACTION = 0.0025
DECODER_MSE_WEIGHT = 0.0
DECODER_TOPK_WEIGHT = 1.0
DECODER_LPIPS_WEIGHT = 0.0
...
TRANSLATOR_SOURCE_CHECKPOINT = "/workspace/le-wm/runs/20260328-132542-pusht/lewm_epoch_13_object.ckpt"
TRANSLATOR_SOURCE_MODEL_MODE = "train"
TRANSLATOR_RESUME_CHECKPOINT = None
TRANSLATOR_RUN_NAME = "action-translator"
TRANSLATOR_MAX_EPOCHS = 30
TRANSLATOR_BATCH_SIZE = 128
TRANSLATOR_NUM_WORKERS = 10
TRANSLATOR_PERSISTENT_WORKERS = True
TRANSLATOR_PREFETCH_FACTOR = 2
...
TRANSLATOR_HIDDEN_DIM = 1024 #256 small
TRANSLATOR_NUM_HIDDEN_LAYERS = 6

TRANSLATOR_CONSOLE_EVERY_STEPS = 20
TRANSLATOR_WRITE_EVERY_STEPS = 500
...
EVAL_POLICY = "/workspace/le-wm/runs/20260328-132542-pusht/lewm_epoch_13_object.ckpt"
EVAL_SEED = 42
EVAL_NUM = 50
...
EVAL_TRANSLATOR_CHECKPOINT = "/workspace/le-wm/runs/20260330-131722-action-translator/lewm_action_translator_epoch_7_object.ckpt"
